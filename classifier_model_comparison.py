...
__fileName__ = 'me_not_me_classifier_model_comparison.py'
__github__ = 'SongChaeYoung98'
__status__ = 'Development'
'''

# train, test 과정을 통해 모델 별 정확도 비교
...
face_classifier = MobileNet  # 여기 바꿔
...
# 여기까지
'''
- VGG16: Out of memory, error.
- ResNet50: me 66.67% | not_me 100% (bad)
- ResNet152: me 88.89% | not_me 100% (perfect)  
- Xception: me 77.78% | not_me 100% (bad)
- MobileNet: me 88.89% | not_me 100% (weird)
- normal: me 77.78% | not_me 100%  
'''
...
model_name = 'face_classifier_MobileNet.h5'  # 이거 바꿔
